...
export default function AddParcelPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <button onClick={() => router.push("/company/carriage")} className="text-sm text-gray-500 hover:text-gray-700 mb-2 flex items-center gap-1">
      ...
      {items.length > 0 && (
        <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
          ...
          <div className="pt-2 text-right">
            <Button onClick={() => router.push("/company/carriage")}>
              Done — View Carriages
            </Button>
          </div>
        </div>
