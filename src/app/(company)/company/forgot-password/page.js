      ...
      <div className="w-full max-w-sm">
        ...
        {submitted ? (
          <div className="bg-white rounded-xl border border-gray-200 p-6 text-center space-y-3">
            ...
            <Link href="/company/login" className="text-sm text-primary hover:underline block">Back to sign in</Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
            ...
            <p className="text-xs text-center text-gray-500"><Link href="/company/login" className="text-primary hover:underline">Back to sign in</Link></p>
          </form>
        )}
      </div>
    </div>
